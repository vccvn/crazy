<?php
namespace Crazy\Repositories\Base;

use Crazy\Validators\Base\ExampleValidator;
...
trait CRUDAction
{
    ...
    protected $validatorNamespace = 'Crazy\Validators';
    ...
    public function getValidator(Request $request, $validatorClass = null)
    {
        ...
        if($this->validatorClass){
            ...
            if(class_exists($this->validatorClass)){
                ...
                $c = 'Crazy\Validators\Base\ExampleValidator';
            }
     ...
     * @param array
     * 
     * @return false|\Crazy\Http\Resources\ExampleResource|\Crazy\Models\Model
     */
